...
const Honda = () => {
     ...
     useEffect(() => {
          fetch('https://user-management-server-koayagszg-servers-projects.vercel.app/product/brand/Honda')
               .then(res => res.json())
...
<a href="#item4" className="btn btn-xs">4</a>
          ...
          {/* Slider start */}
           ...
           {
                loadedData?.map((car) => <HondaCar key={car._id} car={car}></HondaCar>)
           }
           </div>

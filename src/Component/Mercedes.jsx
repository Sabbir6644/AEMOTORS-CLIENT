...
import MercedesCar from "./Catagory/MercedesCar";
...
const Mercedes = () => {
     ...
     useEffect(() => {
          fetch('https://user-management-server-koayagszg-servers-projects.vercel.app/product/brand/Mercedes')
               .then(res => res.json())
...
<a href="#item4" className="btn btn-xs">4</a>
          ...
          {/* Slider start */}
           ...
           {
                loadedData?.map((car) => <MercedesCar key={car._id} car={car}></MercedesCar>)
           }
           </div>
